...
def pubdev_3567():
    ...
    pyunit_utils.compare_numeric_frames(mergedAnsRight, mergedRight, 0.001, tol=1e-10)
    pyunit_utils.compare_numeric_frames(mergedAns, merged, 0.001, tol=1e-10)
    pyunit_utils.compare_numeric_frames(mergedAnsLeft, mergedLeft, 0.001, tol=1e-10)
    pyunit_utils.compare_numeric_frames(mergedAnsRight, mergedRight, 0.001, tol=1e-10)
